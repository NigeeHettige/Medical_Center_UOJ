    ...
    <div class="container" style="position: relative;" id="blur">
        ...
        <div class="main">
            <div class="topbar">
                ...
                <!-- search -->
                <h1 class="welcome"> Welcome <span class="wel_us">
            ...
            <section id="appoinment">
                ...
                <a href="..\booking calendar\calendar.php" class="status2" target="_blank">New Appoinment <ion-icon
                        name="add-circle-outline"></ion-icon></a>
                ...
                <div class="details2 details">
                    <div class="recentOrders1">
                        ...
                        <table>
                            ...
                            $query1 = "SELECT bookings.id, bookings.date, bookings.time_slot, doctor.dr_name
                                            FROM bookings
                                            INNER JOIN doctor ON bookings.dr_id = doctor.dr_id
                                            WHERE bookings.reg_number = '$regNo'
                                ...
                                while ($row1 = mysqli_fetch_assoc($result1)) {
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td data-label="action"><a href="remark.php" class="status"
                                                    style="background-color:grey;"><i
                                                        class="fa-solid fa-arrow-right"></i></i></a></td>
